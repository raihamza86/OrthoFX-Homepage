...
const Button = ({text}) => {
  return (
    <button className="group relative overflow-hidden px-[25px] py-[10px] rounded-full bg-[#f0f0f0] text-black  text-[16px] md:text-[18px] flex items-center gap-2 text-nowrap transition-all duration-300 hover:cursor-pointer">
