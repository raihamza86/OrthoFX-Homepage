...
const HowItWorks = () => {
  return (
    <section className="h-[110vh] md:h-screen w-full bg-[url('/howitworks-bg.png')] bg-cover bg-no-repeat bg-center relative overflow-hidden rounded-[2rem]">
      ...
      {/* Left Text */}
      <div className="absolute top-6 md:top-1/2 md:-translate-y-1/2 left-6 md:left-16 z-10 text-white w-[200px] md:max-w-[400px] lg:min-w-[400px]">
            <h1 className='text-white flex items-center gap-2 italic text-[20px]'><div className='bg-white md:w-20 w-8 h-[1px] rounded-4xl'></div>  How it works</h1>
      ...
      {/* Cards Scroll Section Container */}
      <div className="absolute top-0 right-0 h-full w-full lg:w-[50%] flex justify-end z-10 ">
        {/* Actual Scroll Area */}
        <div
